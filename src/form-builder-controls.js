...
import FileImageUpload from './components/renderer/file-upload -image.vue';
...
export default [
  ...
  {
    rendererComponent: FileImageUpload,
    rendererBinding: 'FileImageUpload',
    builderComponent: FileImageUpload,
    builderBinding: 'FileImageUpload',
    control: {
      label: 'Image Upload',
      component: 'FileImageUpload',
      'editor-component': 'FileImageUpload',
      'editor-control': 'FileImageUpload',
      config: {
      ...
      inspector: [
        ...
        },
        {
          ...
          config: {
            ...
            helper: 'Common file types: image/jpeg/png/jpg,',
          },
        },
        {
          type: 'RequiredCheckbox',
          ...
          config: {
            label: 'Required',
            helper: 'Prevent form from being submitted unless a image is uploaded',
          },
        },
      ],
    },
